                    ...
                    <div class="card-body">
                        <form class="form" method="post" action="{{ route('booking.store') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input name="phone_number" class="form-control" placeholder="370********" minlength="11" maxlength="11">
                                <input name="email" type="email" class="form-control" placeholder="email@mail.com" required>
